        ...
        <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                if (!(empty($username) || empty($password) || empty($firstname) || empty($lastname) || empty($email))){
                        ...
                        $sql = "INSERT INTO payomca_rms . Users (Username, password, FirstName, LastName, Email, Privilege) VALUES ('$username', '$password', '$firstname', '$lastname', '$email', '$privilege');";
